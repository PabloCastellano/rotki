...
URLS_V1: URLS = [
    ...
    ('/blockchains/MATIC/transactions', PolygonTransactionsResource),
    (
        '/blockchains/MATIC/transactions/<string:address>',
        PolygonTransactionsResource,
        'per_address_polygon_transactions_resource',
    ),
    ('/blockchains/MATIC/erc20details', ERC20TokenInfoMATIC),
    ...
    ('/assets/ethereum', EthereumAssetsResource),  # TODO: Rename to EVMAssetsResource
