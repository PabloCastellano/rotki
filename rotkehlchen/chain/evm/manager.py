...
class EvmManager:
    ...
    def get_multi_balance(
        ...
        result = ETH_SCAN[self.chain_id].call(
            manager=self,
    ...
    def query(self, method: Callable, call_order: Sequence[WeightedNode], **kwargs: Any) -> Any:
        ...
        The first node in the call order that gets a succesful response returns.
    ...
    def get_balance(self, account: ChecksumEvmAddress) -> FVal:
        ...
        """
        result = self.get_multi_balance([account])
    ...
    # -- These methods below need to be implemented in the child class --
